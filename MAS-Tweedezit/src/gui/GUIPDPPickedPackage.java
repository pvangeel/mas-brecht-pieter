...
public class GUIPDPPickedPackage extends GUIObject {

	private static final Image image = SpriteStore.get().getImage("graphics/deliverylocation.png");
	...
	public GUIPDPPickedPackage(int id, ContinuousPosition position) {
		super(id);
		this.id = id;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		GUIPDPPickedPackage other = (GUIPDPPickedPackage) obj;
		if (id != other.id)
			return false;
		return true;
	}
